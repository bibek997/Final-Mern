    ...
    <div className='relative h-[500px] w-[75rem] ml-[2.5rem] bg-cover bg-center rounded-[10px] overflow-hidden' style={{backgroundImage:'url("https://img.freepik.com/premium-photo/living-room-with-couch-table-lamp_779887-136.jpg?uid=R155024042&ga=GA1.1.1066521216.1717933232")  ' } }>
      ...
      <div className='flex'>
        <div className='  text-amber-950  ml-10 pt-20 text-xl '>
          ...
          <h2>Contact Us </h2>
          <h1 className='text-5xl font-bold'>Happy to answer
           all
          <br/>
          your questions</h1>

          <p className='pt-4'>
          Welcome to LuxeInterior, where luxury and elegance meet 
          <br/>
          exceptional customer service. We're here to assist you
          <br/>
        ...
        <div className='mt-[80px] ml-10'>
          ...
          <div className='bg-gray-200 h-[33rem] w-[40rem] rounded-[12px]'>
            ...
            <div className='ml-5 flex gap-5 mt-8'>
              <input type="number" placeholder='Phone' className='w-[18rem] h-[4rem] rounded-[10px]  pl-4' />
              <input type="text" placeholder='Subject' className='w-[18rem] h-[4rem] rounded-[10px]  pl-4' />
            </div>
      ...
      <div className="mt-10">
        <div><iframe width="100%" height="500"  src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Kathmandu,Nepal+(MotorsNepal)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe></div>
